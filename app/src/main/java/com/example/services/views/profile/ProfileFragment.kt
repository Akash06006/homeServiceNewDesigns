...
class ProfileFragment : BaseFragment(), ChoiceCallBack {
    ...
    override fun initView() {
        ...
        profileBinding.commonToolBar.topToolbar.visibility = View.GONE
                    ...
                    "btn_submit" -> {
                        ...
                        when {
                            ...
                            !email.matches((ValidationsClass.EMAIL_PATTERN).toRegex()) ->
                                ...
                                mHashMap["lastName"] = Utils(activity!!).createPartFromString(lname)
                                ...
                                mHashMap["address"] =
                                    Utils(activity!!).createPartFromString(address)
                                ...
                                mHashMap["email"] = Utils(activity!!).createPartFromString(email)
                                ...
                                if (!profileImage.isEmpty()) {
                                    ...
                                    userImage =
                                        Utils(activity!!).prepareFilePart("profileImage", f1)
                                }
                                if (UtilsFunctions.isNetworkConnected()) {
                                    baseActivity.startProgressDialog()
