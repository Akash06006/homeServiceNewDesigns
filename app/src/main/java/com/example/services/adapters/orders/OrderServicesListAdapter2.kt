...
import com.example.services.databinding.OrderServiceItem2Binding
...
class OrderServicesListAdapter2(
    ...
    var activity: Context
        ...
        RecyclerView.Adapter<OrderServicesListAdapter2.ViewHolder>() {
    ...
    override fun onCreateViewHolder(@NonNull parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = DataBindingUtil.inflate(
                ...
                R.layout.order_service_item2,
                parent,
                false
        ) as OrderServiceItem2Binding
    ...
    override fun onBindViewHolder(@NonNull holder: ViewHolder, position: Int) {
        ...
        holder.binding!!.tvTotal2.setText(GlobalConstants.Currency + " " + addressList1!![position].totalOrderPrice)
...
////0-Pending/Not Confirmed, 1-> Confirmed , 2->Cancelled , 3->Processing,4//cancelled by company, 5->Completed
    ...
    inner class ViewHolder//This constructor would switch what to findViewBy according to the type of viewType
        ...
        val binding: OrderServiceItem2Binding,
